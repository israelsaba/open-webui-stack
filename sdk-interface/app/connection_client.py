...
class ConnectionClient(ABC):
    ...
    def __init__(self: Self, provider: Literal["Anthropic", "xAI", "Google"]) -> None:
        # switch = {
        #     "Anthropic": ,
        #     "xAI":settings.anthropic_api_key.get_secret_value(),
        #     "Google":settings.anthropic_api_key.get_secret_value(),
        # }
        # self.async_client = 
    ...
    # @abstractmethod
    # async def get_async_client(self: Self) -> Self:
    #     ...
    ...
    def reasoning_content(
        ...
        return ChatCompletionChunk(
            ...
            choices=[
                ChatCompletionStreamChoice(
                    index=0, 
                    delta=ReasoningDelta(reasoning_content=reasoning_content)
                )
            ]
        )
